...
from broker.upstox_order_engine import UpstoxOrderEngine
...
class Runtime:
    ...
    def register_trading(self):
        ...
        try:
            upstox_order_engine = UpstoxOrderEngine()
        except Exception:
            upstox_order_engine = None

        order_manager = OrderManager(
            paper_trader=paper_trader,
            upstox_order_engine=upstox_order_engine,
        )
        ...
        if upstox_order_engine is not None:
            self.container.register(
                "upstox_order_engine",
                upstox_order_engine,
            )
