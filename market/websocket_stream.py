...
class WebSocketService:
    ...
    def __init__(
        ...
        self.token_available = bool(access_token)
        ...
        try:
            ...
            print(f"⚠️ Could not initialize MarketDataStreamerV3: {e}")
            self.streamer = None
    ...
    def start(self):
        ...
        if not self.token_available or self.streamer is None:
            print("⚠️ UPSTOX_ACCESS_TOKEN is not configured in .env.")
            print("WebSocket feed is standing by. Add your token to stream live ticks.")
            return
