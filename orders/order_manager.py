...
class OrderManager:
    ...
    def __init__(self, paper_trader=None, upstox_order_engine=None):
        """
        Order Manager
        ...
        upstox_order_engine : UpstoxOrderEngine | None

        Runtime will inject the shared engines.
        """
        ...
        self.upstox_order_engine = upstox_order_engine
    ...
    def place_order(
        ...
        if mode.upper() == "PAPER":
            ...
            if self.upstox_order_engine is not None:
                print()
                print("=" * 60)
                print("⚡ PLACING LIVE ORDER VIA UPSTOX")
                print("=" * 60)
                res = self.upstox_order_engine.place_order(
                ...
                order["live_result"] = res
                print(f"Upstox Order Result: {res}")
            else:
                print()
                print("⚠️ Upstox Order Engine not available for LIVE mode.")
